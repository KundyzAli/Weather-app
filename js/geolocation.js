...
export const handleWeatherByGeolocation = () => {
    ...
    const success = async (pos) => {
        ...
        const response = await fetch(`https://api.geoapify.com/v1/geocode/reverse?lat=${crd.latitude}&lon=${crd.longitude}&lang=ru&apiKey=eb4207b9c5b54ae9842345343a14be60`);
